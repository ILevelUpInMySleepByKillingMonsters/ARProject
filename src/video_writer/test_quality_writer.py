...
from ..quality_segmentation import ImageQualitySegmenterProcessor
...
image_segment_processor = ImageQualitySegmenterProcessor()
face_detector = ImageFaceDetectorProcessor()

cap = cv2.VideoCapture(f"{DATA_DIR}/egon-video-short.mp4")
bg_video = cv2.VideoCapture(f"{DATA_DIR}/slav-fest-short.mp4")
